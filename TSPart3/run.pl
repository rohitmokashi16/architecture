...
@canfiles = ( "intUnit0", "intUnit1",  "intUnit2",  "intUnit3",
              "intUnit4",  "intUnit5",  "intUnit6",  "intUnit7",
              "intUnit8",  "intUnit9",
              "fpUnit1",   "fpUnit2",
              "intUnitMemUnit1", "intUnitMemUnit2", "intUnitMemUnit3",
              "intUnitMemUnit4", "intUnitMemUnit5", "intUnitMemUnit6",
              "intUnitMemUnit7", "intUnitMemUnit8", "intUnitMemUnit9",
              "intUnitMemUnit10",
              "fpUnitMemUnit1",  "fpUnitMemUnit2", "fpUnitMemUnit3",
              "fpUnitMemUnit4",  "fpUnitMemUnit5", "fpUnitMemUnit6",
              "brUnit1",   "brUnit2",   "brUnit3",   "brUnit4",
              "brUnit5",   "brUnit6"
            );

$candir = "/u/css/classes/5483/161/TSPart3/Inputs/";
